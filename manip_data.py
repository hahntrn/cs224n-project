...
def parse_batch(squad_dict):
    ...
    return title_batch, context_batch, question_batch, ids_batch, answer_batch
...
def augment_squad(path):
    ...
    title_batch, context_batch, question_batch, ids_batch, answer_batch = parse_batch(squad_dict)
